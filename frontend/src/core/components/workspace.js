...
export async function create(name) {
  ...
  patchState((s) => ({
    ...
    uiState: { ...s.uiState, activeWorkspaceId: ws.id, activeHostId: '', activeRequestId: '', activeView: 'request' },
    tree: [],
    requests: {},
    hosts: [],
    environments: [],
...
export async function deleteWorkspace(id) {
  ...
  patchState((st) => ({
    ...
    uiState: { ...st.uiState, activeWorkspaceId: nextActive, activeHostId: '', activeRequestId: '', activeView: 'request' },
    tree: [],
    requests: {},
    hosts: [],
    environments: [],
